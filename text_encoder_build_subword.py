...
tf.flags.DEFINE_integer('min_count', 2, 'Minimum subtoken count in corpus')
tf.flags.DEFINE_integer('corpus_max_lines', 3000000,
...
def main(unused_argv):
  ...
  encoder = text_encoder.SubwordTextEncoder.build_to_target_size( 32000, token_counts, 1, 1000 )
